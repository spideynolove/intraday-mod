...
class BinanceArchiveProvider(Provider):
    ...
    def reset(
        ...
        self._episode_start_datetime = self._df.datetime.iloc[
            trade_index
        ].to_pydatetime()
    ...
    def __next__(self) -> NamedTuple:
        ...
        return Trade(
            datetime=dt, operation=operation, amount=amount, price=price
        )
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(data_dir={self.data_dir}, symbol={self.symbol}, date_from={self.date_from}, date_to={self.date_to})"
